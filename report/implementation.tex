...
dance, bdance, degen
static libraries libdecs and libnqdecs.
...
% - Building the boolean matrix. (Description almost done).
% - Memory requirements in terms of the number of nodes and how it scales.
